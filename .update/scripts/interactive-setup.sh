...
# Production URL
echo ""
echo "What is your production website URL?"
echo "This will be used for:"
echo "• Logging and status messages during updates"
echo "• Documentation and configuration comments"
echo "• Identifying which site is being updated"
echo ""
...
echo ""
echo "Which tool was used to provision your production server?"
echo "This helps automatically configure:"
echo "• Server file paths and directory structure"
echo "• SSH user accounts and permissions"
echo "• Deployment methods available for your host"
echo "• Default settings optimized for your provider"
echo ""
echo "1) ServerPilot"
echo "2) Ploi"
...
echo "• File synchronization and directory access"
echo "• Production environment connectivity testing"
echo ""
...
echo "This determines how the update scripts handle asset synchronization:"
echo "• Local storage: Downloads production assets via FTP/SFTP"
echo "• Cloud storage (S3, Spaces): Skips asset sync - assumes shared storage"
echo "• Saves time by only syncing when necessary"
echo ""
...
echo ""
echo "Directory paths that exist on both local and production:"
echo "These paths must be identical on both environments:"
echo "• Backup directory: Where database backups are stored"
echo "• Uploads directory: Where user-uploaded assets are kept"
echo "• Paths are relative to your project root directory"
echo ""
...
echo ""
echo "Optional: Sync additional directories beyond assets and database:"
echo "Useful for:"
echo "• Runtime cache directories that affect functionality"
echo "• Configuration files that change on production"
echo "• Generated files or temporary data"
echo "• Any other directories needed for local development"
echo ""
...
echo "Enable if your project requires:"
echo "• Compiling CSS/SCSS or JavaScript during updates"
echo "• Processing frontend assets after dependency updates"
echo "• Running build tools like Webpack, Vite, or Gulp"
echo "• Generating production-ready static assets"
echo ""
